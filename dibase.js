...
(function (cmds) {
	...
	var cl = cmds.length; for (var i = 0; i < cl; i++) { var c = cmds[i];
		(function (c) { di.con[c] = di.usecon ? function () { if (di.usecon && typeof console !== 'undefined' && typeof console[c] == 'function') { return console[c].apply(console, arguments); } } : noop })(c);
	};
